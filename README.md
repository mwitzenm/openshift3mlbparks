...
`````
$ oc create -f https://raw.githubusercontent.com/mwitzenm/openshift3mlbparks/master/mlbparks-template-wildfly.json
$ oc new-app mlbparks-wildfly
`````
If your environment (Online 3, Dedicated, OSE) has EAP, use this:
`````
$ oc create -f https://raw.githubusercontent.com/mwitzenm/openshift3mlbparks/master/mlbparks-template-eap.json
...
`````
# oc create -f https://raw.githubusercontent.com/mwitzenm/openshift3mlbparks/master/mlbparks-template-wildfly.json -n openshift
`````
